...
from .models.base_product import BaseProduct, ProductNotFoundError
...
class Feed(object):
    ...
    def __repr__(self):
        return 'Feed(platform={0}, len(items)={1})'.format(self.platform.__repr__(), len(self.raw_collection))
