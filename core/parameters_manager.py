...
class ParametersManager(object):
    ...
    """
    def __init__(self, products, input_parameters=OrderedDict()):
    ...
    def are_all_parameters_filled(self):
        ...
        если нет. то спросить их у пользователя, если это интерактивный режим в консоли
        или ошибка, если  спросить нельзя
    ...
    def ask_unfilled_parameters(self):
        ...
        if not self.failed_parameters:
            return
        print('Please specify following parameters to proceed with installation')
